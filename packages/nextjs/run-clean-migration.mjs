...
// Path to the clean schema migration file - using absolute path with __dirname
// Need to go up two levels: from /packages/nextjs to the project root
const migrationFilePath = join(__dirname, '..', '..', 'infrastructure', 'database', 'migrations', '01-clean-schema.sql');
