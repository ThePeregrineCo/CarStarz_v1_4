-- Complete Reset Script for CarStarz Application
...
CREATE INDEX idx_vehicle_modifications_vehicle_id ON vehicle_modifications(vehicle_id);

-- Vehicle Media Indexes
CREATE INDEX idx_vehicle_media_vehicle_id ON vehicle_media(vehicle_id);

-- Vehicle Links Indexes
CREATE INDEX idx_vehicle_links_vehicle_id ON vehicle_links(vehicle_id);

-- Vehicle Specifications Indexes
CREATE INDEX idx_vehicle_specifications_vehicle_id ON vehicle_specifications(vehicle_id);
...
CREATE INDEX idx_user_collections_user_wallet ON user_collections(user_wallet);
CREATE INDEX idx_user_collections_token_id ON user_collections(token_id);
...
CREATE INDEX idx_builder_vehicles_builder_id ON builder_vehicles(builder_id);
CREATE INDEX idx_builder_vehicles_vehicle_id ON builder_vehicles(vehicle_id);
...
CREATE INDEX idx_builder_follows_user_id ON builder_follows(user_id);
CREATE INDEX idx_builder_follows_builder_id ON builder_follows(builder_id);
...
CREATE INDEX idx_club_vehicles_club_id ON club_vehicles(club_id);
CREATE INDEX idx_club_vehicles_token_id ON club_vehicles(token_id);
...
-- For brevity, I'm not including all policies for all tables