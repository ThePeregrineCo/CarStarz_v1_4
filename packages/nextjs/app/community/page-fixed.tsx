...
import { vehicleQueriesV3Fixed } from "~~/lib/api/vehicleQueriesV3Fixed";

const CommunityPageFixed = () => {
  ...
  useEffect(() => {
    const fetchVehiclesDirectly = async () => {
      try {
        ...
        // Fetch vehicles directly using the fixed queries
        const vehicleData = await vehicleQueriesV3Fixed.searchVehicles({});
...
export default CommunityPageFixed;