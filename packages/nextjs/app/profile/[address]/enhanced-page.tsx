...
export default function EnhancedUserProfilePage() {
  ...
  const { data: userProfile, isLoading: isLoadingProfile } = useQuery({
    ...
    queryFn: async () => {
      ...
      const profile = await enhancedUserProfiles.getByWalletAddress(userAddress);
      return profile;
    },
    enabled: !!userAddress,
  });
  ...
  const displayName = userProfile?.display_name || 
                      ...
                      (userAddress ? `${userAddress.slice(0, 6)}...${userAddress.slice(-4)}` : 'Unknown User');
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              {userProfile?.ens_name && userProfile.ens_name !== displayName && (
