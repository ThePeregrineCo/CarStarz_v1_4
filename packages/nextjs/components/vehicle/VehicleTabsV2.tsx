...
import type { CompleteVehicleProfile } from '../../lib/api/vehicleQueriesV3Fixed';
import { adaptVehicleProfile } from '../../lib/types/vehicleProfileAdapter';
...
export function VehicleTabsV2({ 
  ...
  return (
    <div className="bg-white">
      ...
      <div className="p-6">
        {activeTab === 'details' && (
          <VehicleDetailsTab vehicle={adaptVehicleProfile(vehicle, 'v2') as any} isOwner={isOwner} />
        )}
        
        {activeTab === 'media' && (
          <VehicleMediaTab vehicle={adaptVehicleProfile(vehicle, 'v2') as any} isOwner={isOwner} />
        )}
        
        {activeTab === 'parts' && (
          <VehiclePartsTab vehicle={adaptVehicleProfile(vehicle, 'v2') as any} isOwner={isOwner} />
        )}
        
        {activeTab === 'builders' && (
          <VehicleBuildersTab vehicle={adaptVehicleProfile(vehicle, 'v2') as any} isOwner={isOwner} />
        )}
